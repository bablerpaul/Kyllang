    ...
    <Box sx={{ maxWidth: 1120, mx: 'auto', p: { xs: 2, md: 4 } }}>
      ...
      <Box sx={{ display: 'flex', justifyContent: 'center', mb: 4 }}>
        <ToggleButtonGroup
          ...
          sx={{ backgroundColor: 'background.paper', p: 0.5, border: '1px solid', borderColor: 'divider', borderRadius: 2 }}
        >
          <ToggleButton value="qr" sx={{ px: 4, minWidth: 180 }}>
            <QrCodeIcon sx={{ mr: 1 }} />
            Scan QR Code
          </ToggleButton>
          <ToggleButton value="upload" sx={{ px: 4, minWidth: 180 }}>
            <UploadIcon sx={{ mr: 1 }} />
            Upload File
          </ToggleButton>
        </ToggleButtonGroup>
